...
@media(max-width:650px){.dv3{margin:12px 0}.dv3-grid{grid-template-columns:1fr}.dv3-card{padding:16px}.dv3-title{font-size:24px}.dv3-form{grid-template-columns:1fr}.dv3-kpi{font-size:25px}.dv3-scale-grid{grid-template-columns:1fr 1fr}.dv3-scale-item{padding:9px 8px}}
`;
